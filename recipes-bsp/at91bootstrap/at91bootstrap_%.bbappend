...
do_configure_prepend () {
    ...
    echo "CONFIG_IMG_ADDRESS=\"0x10000\""  >> ${S}/board/${AT91BOOTSTRAP_MACHINE}/${AT91BOOTSTRAP_TARGET}
    # Alter size of U-Boot Image to load
    #echo "CONFIG_IMG_SIZE=\"${UBOOT_IMG_SIZE}\""  >> ${S}/board/${AT91BOOTSTRAP_MACHINE}/${AT91BOOTSTRAP_TARGET}
    echo "CONFIG_IMG_SIZE=\"0xA0000\""  >> ${S}/board/${AT91BOOTSTRAP_MACHINE}/${AT91BOOTSTRAP_TARGET}
}